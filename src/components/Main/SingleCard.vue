...
<template>
    ...
    <div class="visible" v-show="upHere">
        ...
        <span class="spancenter">Lingua: <img class="flag" v-if="country !== `EN` " :src="`https://flagsapi.com/${country}/shiny/24.png`"> <img class="flag" v-else src="https://img.freepik.com/free-vector/illustration-uk-flag_53876-18166.jpg?size=626&ext=jpg&ga=GA1.1.1141335507.1707436800&semt=ais" alt=""></span>
